    ...
    <div>
      ...
      <div className="btnFunc__wrap">
        ...
        <button className="btn__item">
          <div className="btn__icon btnFunc__img btnFunc__reverse">
            <svg
        ...
        {/* Btn item 2  */}
        <button className="btn__item">
          <div className="btn__icon btnFunc__img btnFunc__hint">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="hint__badge">5</span>
          </div>
        </button>

        {/* Btn item 3  */}
        <button className="btn__item">
          <div className="btn__icon btnFunc__img btnFunc__note">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              fill="currentColor"
            ...
            <span className="note__badge">OFF</span>
          </div>
        </button>

        {/* Btn item 4  */}
        <button className="btn__item">
          <div className="btn__icon btnFunc__img">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 512"
              fill="currentColor"
